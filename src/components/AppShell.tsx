  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="border-t border-sidebar-border px-3.5 py-3 text-xs text-sidebar-muted flex items-center justify-between">
          <span className="font-medium text-sidebar-foreground/90">Designed by <span className="font-bold text-primary">Shine Infosolutions</span></span>
        </div>
      </aside>
